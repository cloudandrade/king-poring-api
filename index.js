...
logger.debug(
  `Swagger documentation available on ${process.env.API_HOST}:${process.env.API_PORT}/api-docs`
);
...
app.listen(PORT, async () => {
  if (
    process.env.LOG_SERVICE_TYPE === 'LOG' ||
    process.env.LOG_SERVICE_TYPE === 'BOTH'
  ) {
